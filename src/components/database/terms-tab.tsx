  ...
  return (
    <>
      <p className="mb-3 text-sm text-ink/70">
        Формулировки срока появляются выпадающим списком в поле «Срок» задачи и мастер-плана.
        Система сама переводит их в даты относительно дат форума и старта продаж. Пример расчёта —
        для {EXAMPLE_TEXT}.
      </p>
      <DataTable
        rows={rows}
