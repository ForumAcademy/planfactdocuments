    ...
    <header className="sticky top-0 z-40 bg-brand-dark text-white shadow-sm print:hidden">
      <div className="mx-auto flex h-14 max-w-[1600px] items-center gap-4 px-4">
        <Link href="/" className="flex items-center gap-2 font-semibold tracking-tight">
          <span className="flex size-7 items-center justify-center rounded bg-white text-xs font-bold text-brand-dark">
            СФ
          </span>
          <span className="text-base sm:text-lg">Статус форумы</span>
        </Link>
        <NavLinks />
