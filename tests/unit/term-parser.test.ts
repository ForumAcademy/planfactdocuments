...
const cases: Expected[] = [
  ...
  { term: 'на протяжении этапа', stage: 2, start: '2026-11-10', end: '2027-03-09' },
...
describe('parseTerm — свободные формулировки', () => {
  const cases: [string, string, string][] = [
    ['за неделю до форума', '2027-02-24', '2027-03-03'],
    ['за две недели до форума', '2027-02-17', '2027-02-24'],
    ['за месяц до мероприятия', '2027-02-03', '2027-02-10'],
    ['полтора месяца до форума', '2027-01-20', '2027-01-27'],
    ['за 3 дня до начала форума', '2027-02-28', '2027-03-07'],
    ['за 2 недели до старта продаж', '2026-10-20', '2026-10-27'],
    ['через 3 дня после старта продаж', '2026-11-13', '2026-11-13'],
    ['в течение недели после старта продаж', '2026-11-10', '2026-11-17'],
    ['через неделю после форума', '2027-03-12', '2027-03-18'],
    ['накануне форума', '2027-03-09', '2027-03-09'],
    ['после форума', '2027-03-12', '2027-03-18'],
    ['до 15.10.2026', '2026-10-08', '2026-10-15'],
    ['с 01.10.2026 по 15.10.2026', '2026-10-01', '2026-10-15'],
    ['01.12-15.12', '2026-12-01', '2026-12-15'],
    ['к 20.01.27', '2027-01-13', '2027-01-20'],
  ];
  for (const [term, start, end] of cases) {
    it(term, () => {
      const r = parseTerm(term, refs, 2);
      expect(r.needsClarification).toBe(false);
      expect([r.start, r.end]).toEqual([start, end]);
    });
  }
  it('расплывчатые сроки остаются примерными', () => {
    expect(parseTerm('при выборе площадки', refs, 1).needsClarification).toBe(true);
    expect(parseTerm('по графику платежей договоров', refs, 2).needsClarification).toBe(true);
  });
});
